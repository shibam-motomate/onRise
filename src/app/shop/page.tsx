    ...
    <main>
      <section style={{ background: '#ECE3D1', borderBottom: '1px solid #E3D5BB' }}>
        <div className="rw" style={{ maxWidth: MAX, margin: '0 auto', padding: '56px 40px 50px', position: 'relative' }}>
          ...
          <div style={{ fontSize: 13, color: '#8E7A61', marginBottom: 12 }}>
          ...
          <p style={{ color: '#6E5C47', fontSize: 16, maxWidth: 520, margin: 0, lineHeight: 1.6 }}>Timeless furniture for every room — crafted in the hills, made for slow living.</p>
        </div>
      </section>
      ...
      <section className="rw" style={{ maxWidth: MAX, margin: '0 auto', padding: '40px 40px 100px' }}>
          ...
          {categories.map((label) => {
            ...
            return (
              <div
                ...
                style={{ cursor: 'pointer', padding: '10px 20px', borderRadius: 999, fontSize: 14, fontWeight: 500, border: `1px solid ${active ? '#382D21' : '#DFD1B7'}`, background: active ? '#382D21' : '#FFFFFF', color: active ? '#F5EFE3' : '#5C4C39' }}
              >
                {label}
              </div>
            );
        ...
        <div style={{ fontSize: 14, color: '#8E7A61', marginBottom: 22 }}>{filtered.length} pieces</div>
